...
# Remove number 5 and 7 from train_data and val_data
# 5 and 7 are considered as the anomaly numbers
train_data = [data for data in train_data if data[1] != 5 and data[1] != 7]
for i in range(0,len(train_data)):
    train_normal_array.append(train_data[i][0])

val_data = [data for data in val_data if data[1] != 5 and data[1] != 7]
for i in range(0,len(val_data)):
    val_array.append(val_data[i][0])

# We're testing with all numbers
test_anom_data = [data for data in test_data if data[1] == 5 or data[1] == 7]
test_normal_data = [data for data in test_data if data[1] != 5 and data[1] != 7]
